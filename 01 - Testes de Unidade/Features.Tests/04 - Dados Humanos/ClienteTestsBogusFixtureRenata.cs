...
{
    [CollectionDefinition(nameof(ClienteBogusCollectionRenata))]
    public class ClienteBogusCollectionRenata : ICollectionFixture<ClienteTestsBogusFixtureRenata>
    { }

    public class ClienteTestsBogusFixtureRenata : IDisposable
    {
